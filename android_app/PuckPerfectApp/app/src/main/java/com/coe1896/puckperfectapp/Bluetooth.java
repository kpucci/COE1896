...
public class Bluetooth extends Activity {
    ...
    public static final String DEVICE_EXTRA = "com.coe1896.puckperfectapp.SOCKET";
    public static final String DEVICE_UUID = "com.coe1896.puckperfectapp.uuid";
    private static final String DEVICE_LIST = "com.coe1896.puckperfectapp.devicelist";
    private static final String DEVICE_LIST_SELECTED = "com.coe1896.puckperfectapp.devicelistselected";
    public static final String BUFFER_SIZE = "com.coe1896.puckperfectapp.buffersize";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnConnect.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                chatIntent = new Intent(getApplicationContext(), RecordActivity.class);
                chatIntent.putExtra(DEVICE_EXTRA, device);
                chatIntent.putExtra(DEVICE_UUID, mDeviceUUID.toString());
                chatIntent.putExtra(BUFFER_SIZE, mBufferSize);
